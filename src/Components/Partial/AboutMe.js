      ...
      <div className="w-[90%] h-full flex justify-center items-center">
        <div className="w-[80%] h-[80%] flex flex-col justify-center items-center">
          <div className="w-full h-[20%] flex justify-start items-center">
            <p className="text-slate-200 text-3xl font-bold tracking-[0.8px] relative">
          ...
          <div className="w-full h-[80%] flex justify-center items-center">
            ...
            <div
              id="description"
              className="w-[70%] h-full flex flex-col justify-start items-center space-y-2"
            >
              <p className="text-light text-5xl font-thin tracking-[1px] relative left-[5%] top-[3%] select-none">
              ...
              <p className="text-light text-5xl font-thin tracking-[1px] relative left-[5%] top-[10%] select-none">
